...
export const shared = defineConfig({
  ...
  head: [
    ...
    ['meta', {
      property: 'og:title',
      content: '@bitrix24/b24icons | Битрикс24 SVG иконки для разработки веб-приложений'
    }],
    ['meta', { property: 'og:site_name', content: '@bitrix24/b24icons' }],
    ['meta', {
      property: 'og:image',
      content: `${ configParams.domain }${ configParams.baseFolder }bitrix24_b24icons.jpg`
    }],
  ...
  vite: {
    ...
    optimizeDeps: {
      ...
      include: ['tailwindcss/colors', 'tailwind-variants',]
    }
  }
})
