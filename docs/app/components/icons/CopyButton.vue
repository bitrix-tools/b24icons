...
const options = ref([
  { label: 'Копировать как компонент Vue', action: copyVue },
  { label: 'Копировать как Vue B24Icon', action: copyVueB24Icon },
  { label: 'Копировать Название', action: copyComponentName },
  { label: 'Копировать SVG', action: copySVG },
  { label: 'Копировать Data URL', action: copyDataUrl }
])
</script>
